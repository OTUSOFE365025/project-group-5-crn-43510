...
| **Primary functional requirements** | From the use cases presented, the primary drivers were determined to be:<ul><li>UC-1 (Access Academic Details): Because it directly supports the core business of providing personalized, accurate student information via a natural-language interface.</li><li>UC-2 (Receive Notifications): Because it is critical for engaging users and ensuring timely communication, directly impacting the platform's utility.</li><li>UC-5 (Regulate System Integrations): Because it is crucial for system operations, ensuring secure and reliable connectivity with external institutional systems (LMS, Registration) and maintaining data integrity.</li></ul>|
| **Quality attribute scenarios** | The scenarios were described in the Quality Attribute Scenarios section. They have now been prioritized (based on the provided Importance and Difficulty ratings) as follows:<ul><li>QA-1 (Performance)<ul><li>Importance to the Customer: High</li><li>Difficulty of Implementation: High</li></ul></li><li>QA-2 (Availability)<ul><li>Importance to the Customer: High</li><li>Difficulty of Implementation: High</li></ul></li><li>QA-3 (Security)<ul><li>Importance to the Customer: High</li><li>Difficulty of Implementation: High</li></ul></li><li>QA-4 (Scalability)<ul><li>Importance to the Customer: High</li><li>Difficulty of Implementation: Medium</li></ul></li><li>QA-5 (Modifiability)<ul><li>Importance to the Customer: Medium</li><li>Difficulty of Implementation: Medium</li></ul></li></ul>|
| **Constraints** | All of the operational and technical boundaries discussed in the System Constraints section are included as drivers:<ul><li>CON-1 (Scalability Requirement): Support $\ge$ 5,000 concurrent users.</li><li>CON-2 (Cross-Platform Access): Seamless operation across web and mobile browsers.</li><li>CON-3 (Cloud Deployment Environment): Hosted on a university-approved cloud service.</li><li>CON-4 (Privacy and Compliance): Strict adherence to institutional policies.</li><li>CON-5 (Performance Target): Response time $\le$ 2 seconds for most queries.</li><li>CON-6 (Unified AI Backend Models): Reliance on a single underlying AI backend for both voice and text.</li></ul>|
| **Architectural concerns** | All of the identified design priorities and risks from the Architectural Concerns section are included as drivers:<ul><li>CRN-1 (Define Overall Microservice and Integration Structure).</li><li>CRN-2 (Utilize Team’s Knowledge of Python (FastAPI) and React for UI).</li><li>CRN-3 (Ensure Secure Handling of SSO and Personally Identifiable Information).</li><li>CRN-4 (Design for Scalability and Cloud Auto-Deployment).</li><li>CRN-5 (Simplify Integration of Future AI Models and External APIs).</li><li>CRN-6 (Provide Clear Module Responsibility Allocation for Team Members).</li></ul>|
